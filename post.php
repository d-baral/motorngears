...
<div class="new_category">
        ...
        <a class="newpost-btn-link" href="newpost.php"><div class="new-post-button">Create New Post</div></a>
...
<h1 class="head-title">
    ...
    ?>
            <tr>
                ...
                <td> 
                    <button class="icon-button" name="category_edit" action="category_action.php">
                    <img src="./assets/icons/edit.png" alt="Edit Icon">
                    </button>
                </td>
                <td> 
                   <a href="post_action.php?pid=<?php echo $pid; ?>" onclick="confirm_delete();" class="icon-button">
